    ...
    <div className="top-0 absolute bg-cover">
      ...
      <div className="flex justify-center items-center h-screen">
        <div className="card bg-lightGrey bg-opacity-25 w-2/4">
          <div>
            <h2 className="text-4xl font-aclonica pt-14 pb-14 text-left pl-12 text-white">Sign up</h2>
            ...
            <div className="form-control">
              ...
              <div className="form-control ">
                <label className="label">
                  <span className="label-text text-base pt-3 font-bold text-white">Email</span>
              ...
              <input className="btn border-none w-56 mt-4 bg-rosewood hover:bg-azure" type="submit" value='Sign up' />
            </form>
            <p className='pt-4 pb-14 text-white'>Already have an account?  <Link className='font-bold hover:text-vividGreen' to='/login'> Sign in</Link></p>
