    ...
    <>
      ...
      <div className='relative flex items-center justify-around mt-6'>
        ...
        <div class="btn-group mx-6">
          ...
          <button class="btn bg-darkRed"> Location <img className='text-white ml-2' src={locationIcon} alt="" /></button>
        ...
        <div class="btn-group mx-6">
          ...
          <button class="btn bg-darkRed">  Search  <img className='text-white ml-2' src={searchIcon} alt="" /></button>
      ...
      <div className='relative flex items-center justify-around mt-12'>
        <div className='bg-white p-24 font-semibold'>
          ...
          <div class="form-control w-full max-w-xs pb-4">
            ...
            <input type="text" placeholder="Type here" class="input  w-full max-w-xs p-6  max-w-xs bg-lightGrey" />
          ...
          <div class="form-control w-full max-w-xs pb-4">
            ...
            <input type="text" placeholder="Type here" class="input  w-full p-6  max-w-xs bg-lightGrey" />
            ...
            <div class="card w-full bg-base-100 shadow-xl p-6">
              <div className=' flex items-center justify-between pb-6'>
                <div>
                  ...
                  <h1 className='font-semibold text-xl'>CalciteX Cybarmetics LLp</h1>
                </div>
                <div>
                  <p className='btn bg-lightGrey text-black rounded-full px-2'>Internship</p>
                </div>
              </div>
              <div className=' flex items-center justify-start font-bold pt-4 pb-4'>
                ...
                <div className='flex items-center'>
                  ...
                  <h1>
                    Work From Home/ Part time allowed</h1>
                </div>
              </div>
              ...
              <div className=' flex items-center justify-between'>
                <div >
                  <a href="" className='underline underline-offset-1 text-vividGreen'>View Details</a>
                </div>
                <div>
                  <button className='bg-lightRose rounded-full px-2 py-1 text-black'>Apply</button>
                </div>
              </div>
          ...
          <div>
            <div class="card w-full bg-base-100 shadow-xl p-6">
              <div className=' flex items-center justify-between pb-6'>
                ...
                <div>
                  <button className='btn bg-lightGrey rounded-full px-2 text-black'>Internship</button>
                </div>
              </div>
              <div className=' flex items-center justify-start font-bold pt-4 pb-4'>
                <div>
