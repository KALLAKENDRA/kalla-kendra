...
const StartYourJourny = () => {
  return (
    <>
      ...
      <div className='flex flex-col items-center justify-center gap-4 lg:flex-row'>
        ...
        <div className="mr-20 ml-28">
          ...
          <div><input
            ...
            className=" relative z-10 placeholder-monsoon bg-rosewood rounded-2xl w-56 md:w-104 h-14 border-2 border-white  -ml-7 px-10"
          /></div>
        ...
        <div>
          <button className="bg-black opacity-50 text-white text-opacity-100 px-6 py-4 lg:py-4   md:py-0 mt-4 rounded-xl text-lg hover:bg-yellow hover:opacity-100  hover:text-black hover:font-bold relative z-10 w-52 h-14 md:h-10 lg:h-14">
            Search
          </button>
        </div>
      </div>
      ...
      <div className="relative z-10 flex  items-center justify-evenly lg:mt-64 flex-col lg:flex-row mt-10">
        <div className="w-96">
        ...
        <div className="w-auto  m-4 md:w-106">
          <img src={bgStart} alt="" />
        </div>
      </div>
    </>
